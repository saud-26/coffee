        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/__sxud/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center text-sm transition-all hover:bg-[var(--coffee-accent)] hover:text-white" style={{ backgroundColor: "rgba(61, 40, 32, 0.5)", color: "var(--coffee-text-secondary)", border: "1px solid var(--coffee-border)" }}>
